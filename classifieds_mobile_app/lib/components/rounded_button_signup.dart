...
class RoundedButtonSignup extends StatefulWidget {
  final String text;
  ...
  @override
  State<RoundedButtonSignup> createState() => RoundedButtonSignupState();
}

class RoundedButtonSignupState extends State<RoundedButtonSignup> {
